...
if args.yarn:
    save_path = f'{root}/checkpoints/{save_abbr}-lctx-yarn{args.factor}'
else:
    save_path = f'{root}/checkpoints/{save_abbr}-lctx-pi{args.factor}'
...
training_args = TrainingArguments(
    ...
    run_name=f'{save_abbr}-lctx-{"yarn" if args.yarn else "pi"}{args.factor}-{datetime.now().strftime("%Y%m%d-%H%M%S")}',
