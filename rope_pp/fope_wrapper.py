...
from .modeling_llama_fope import LlamaForCausalLM
...
class FoPECausalLM(HuggingFaceBaseModel):
    ...
    def _load_model(self, path: str, kwargs: dict, peft_path: Optional[str] = None, peft_kwargs: dict = dict()):
        ...
        if self.rope_config is not None and 'scaling_factor' in self.rope_config:
