...
from .modeling_llama_mask import LlamaForCausalLM
...
class MaskCausalLM(HuggingFaceBaseModel):
    ...
    def _load_model(self, path: str, kwargs: dict, peft_path: Optional[str] = None, peft_kwargs: dict = dict()):
        ...
        self.config.mask_config = self.mask_config ## 
        print(self.config)
